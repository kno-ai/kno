...
Pages (by time since last distill):
  ...
  3. Vasculitis Treatment   — 1 month ago
  4. Payment Processing     — 2 weeks ago
  5. EFT Processing         — 6 days ago
  6. Homebrewing            — never distilled
...
Your pages:
  ...
  Payment Processing     last distilled 2 weeks ago
  Homebrewing            never distilled
  Vasculitis Treatment   last distilled 1 month ago
```
...
echo "<guidance + initial content>" | kno page create --name "Homebrewing"

# create empty — content added on first distill
kno page create --name "Homebrewing"
